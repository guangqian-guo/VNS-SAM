...
class VNS_SAM_Decoder(MaskDecoder):
    def __init__(self, model_type):
        ...
        self.dense_pred_head = nn.Sequential(
            ...
            nn.GELU(),
            nn.Conv2d(transformer_dim, 1, 1, 1)
        )
    ...
    def forward(
        ...
        for i_batch in range(batch_len):
            mask, inter_mask, fusion_mask, iou_pred, mask_feat, attn_map = self.predict_masks(
        ...
        if hq_token_only:
            return masks_hq, edge_pred, inter_masks_hq, inter_edge_pred, fusion_preds
        else:
            return masks_sam, masks_hq, edge_pred, inter_masks_hq, inter_edge_pred, fusion_preds, mask_feats, attn_maps
    ...
    def predict_masks(
        ...
        return masks, inter_masks, fusion_mask, iou_pred, edge_pred, attn_map