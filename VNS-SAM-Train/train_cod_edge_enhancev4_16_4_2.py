'''
只有token加上高频信息，feat 不变
high freq token weight 0..5
'''
...
class SAMAggregatorNeck(nn.Module):
    ...
    def forward(self, inputs):
        ...
        return img_feat, edge_feat, high_freq_tokens
...
class MaskDecoderHQ(MaskDecoder):
    ...
    def forward(
        ...
        hq_features, edge_pred, high_freq_tokens = self.neck(interm_embeddings)    # 1 32 256 256, 1 1 256 256, 1,256, 1, 256 64 64
    ...
    def predict_masks(
        ...
        image_embeddings = image_embeddings + 0.3 * edge_feat 
