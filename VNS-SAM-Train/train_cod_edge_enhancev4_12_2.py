...
class MaskDecoderHQ(MaskDecoder):
    ...
    def predict_masks(
        ...
        iou_token_out = hs[:, 0, :]
        mask_tokens_out = hs[:, 1 : (3 + self.num_mask_tokens), :]
...
def train(args, net, optimizer, train_dataloaders, valid_dataloaders, lr_scheduler):
    ...
    for epoch in range(epoch_start, epoch_num): 
        ...
        for data in metric_logger.log_every(train_dataloaders,100):
            ...
            loss = (loss_mask_f + loss_dice_f) +  loss_edge + loss_mask_b + loss_dice_b 
            
            loss_dict = {"loss_mask_foreground": loss_mask_f, "loss_dice_foregrond":loss_dice_f, "loss_mask_background": loss_mask_b, "loss_dice_background":loss_dice_b, "loss_edge": loss_edge,}
