...
class MaskDecoderHQ(MaskDecoder):
    ...
    def forward(
        ...
        hq_features = self.embedding_encoder(image_embeddings)  # wo lowlevel fusion
        # hq_features = image_embeddings           # wo hq_feature
    ...
    def predict_masks(
        ...
        # upscaled_embedding_ours = upscaled_embedding_sam   # wo hq-feature
        upscaled_embedding_ours = self.embedding_maskfeature(upscaled_embedding_sam) + hq_feature  # wo lowlevel fusion
