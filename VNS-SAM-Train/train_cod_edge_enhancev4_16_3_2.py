...
class SAMAggregatorNeck(nn.Module):
    ...
    def forward(self, inputs):
        ...
        return img_feat, edge_feat, high_freq_feats
...
class MaskDecoderHQ(MaskDecoder):
    ...
    def forward(
        ...
        hq_features, edge_pred, high_freq_feats = self.neck(interm_embeddings)    # 1 32 256 256, 1 1 256 256, 1,256, 1, 256 64 64
