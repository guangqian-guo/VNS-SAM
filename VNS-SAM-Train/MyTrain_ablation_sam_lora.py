...
class sam_adapter(nn.Module):
    ...
    def __init__(self, args):
        ...
        self.sam.train()
        self.mask_decoder_batch = MaskDecoderTT(args.model_type)
    ...
    def init_weight(self):
        for name, para in self.named_parameters():
            ...
            if "prompt_encoder" in name or ("image_encoder" in name and "lora" not in name) or ("mask_decoder" in name and "batch" not in name):
