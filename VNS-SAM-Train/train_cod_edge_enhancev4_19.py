...
class SAMAggregatorNeck(nn.Module):
    ...
    def forward(self, inputs):
        ...
        return img_feat, edge_feat, sup_feat
...
class MaskDecoderHQ(MaskDecoder):
    ...
    def forward(
        ...
        hq_features, edge_pred, sup_feats = self.neck(interm_embeddings)    # 1 32 256 256, 1 1 256 256
        ...
        for i_batch in range(batch_len):
            mask, iou_pred, mask_feat = self.predict_masks(
                ...
                sup_feat = sup_feats[i_batch].unsqueeze(0),
            )
            masks.append(mask)
    ...
    def predict_masks(
        ...
        image_embeddings = image_embeddings + sup_feat
        ...
        upscaled_embedding_ours = (self.embedding_maskfeature(upscaled_embedding_sam) + hq_feature) # b 32 1024 1024
