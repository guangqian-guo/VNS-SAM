"""v5
DPC 模块 修改  去掉 +feat
dense_pred = self.dense_attn(feat, hq_token, hq_token) + feat  --> dense_pred = self.dense_attn(feat, hq_token, hq_token)
"""
...
class MaskDecoderEnhancefusionv5(MaskDecoder):
    ...
    def predict_masks(
        ...
        feat = src
        dense_pred = self.dense_attn(feat, hq_token, hq_token) 
