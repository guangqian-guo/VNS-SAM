...
if __name__ == "__main__":
    ...
    train_datasets = [dataset_dis, dataset_thin, dataset_fss, dataset_duts, dataset_duts_te, dataset_ecssd, dataset_msra, dataset_cod]
    valid_datasets = [dataset_dis_val, dataset_coift_val, dataset_hrsod_val, dataset_thin_val, dataset_cha_val, dataset_camo_val, dataset_cod10k_val, dataset_NC4K_val] 
