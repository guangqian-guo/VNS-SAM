...
def train(args, net, optimizer, train_dataloaders, valid_dataloaders, lr_scheduler):
    ...
    for epoch in range(epoch_start, epoch_num): 
        ...
        for data in metric_logger.log_every(train_dataloaders,100):
            ...
            loss_masks_dense, loss_dice3 = loss_masks(masks_dense, labels/255.0, len(masks_hq))
            
            loss =  loss1 + loss2 + loss_masks_dense + loss_dice3
            ...
            loss_dict = {"loss_mask1": loss_mask1, "loss_dice1":loss_dice1, "loss_edge1": loss_edge1, 
                         ...
                         "loss_masks_dense": loss_masks_dense, "loss_dice3": loss_dice3}
