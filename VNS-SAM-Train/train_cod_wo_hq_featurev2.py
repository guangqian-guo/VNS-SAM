...
class MaskDecoderHQ(MaskDecoder):
    ...
    def predict_masks(
        ...
        upscaled_embedding_ours = self.embedding_maskfeature(upscaled_embedding_sam)  # wo hq feature v2
        # upscaled_embedding_ours = upscaled_embedding_sam                  # wo hq feature v1
