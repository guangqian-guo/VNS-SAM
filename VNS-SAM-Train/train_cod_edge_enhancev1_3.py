...
class MaskDecoderHQ(MaskDecoder):
    ...
    def forward(
        ...
        hq_features, edge_feat = self.neck(interm_embeddings)    # 1 32 256 256, 1 1 256 256
        edge_pred = torch.sigmoid(self.edge_pred_head(edge_feat))
    ...
    def predict_masks(
        ...
        upscaled_embedding_ours = (self.embedding_maskfeature(upscaled_embedding_sam) + hq_feature) * (edge_feat + 1)
