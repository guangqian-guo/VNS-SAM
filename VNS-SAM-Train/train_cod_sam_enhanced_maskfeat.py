...
class MaskDecoderHQ(MaskDecoder):
    ...
    def forward(
        ...
        hq_feat = self.neck(interm_embeddings)
    ...
    def predict_masks(
        ...
        upscaled_embedding_sam = self.output_upscaling(src) + hq_feat   # enhanced feat  1 32 256 256
        #TODO multi scale?
