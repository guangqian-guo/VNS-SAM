...
if __name__ == "__main__":
    ...
    # added by guo
    dataset_sd = {"name": "SBU",
                    "im_dir": "./data/SD/SBU/Train/Imgs",
                    "gt_dir": "./data/SD/SBU/Train/GT",
                    "edge_dir": "./data/COD/TrainDataset/Edge",
                    "im_ext": ".jpg",
                    "gt_ext": ".png"}

    # valid set
    dataset_sbu_val = {"name": "SBU",
                    "im_dir": "./data/SD/SBU/Test/Imgs",
                    "gt_dir": "./data/SD/SBU/Test/GT",
                    "im_ext": ".jpg",
                    "gt_ext": ".png"}
    ...
    # guo
    train_datasets=[dataset_sd]
    valid_datasets = [dataset_sbu_val]
